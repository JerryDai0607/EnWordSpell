(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Scripts/Libs/whevent.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a08aavD2zhJWr5nK2y2I2DJ', 'whevent', __filename);
// Scripts/Libs/whevent.js
...
window.whevent = {
	...
	bind: function bind(signal, func, self) {
	...
	bindPriority: function bindPriority(signal, func, self) {
		if (!this._callStacks[signal]) {
			this._callStacks[signal] = [];
		}
	...
	bindOnce: function bindOnce(signal, func, self) {
		if (!this._callStacks[signal]) {
			this._callStacks[signal] = [];
		}
	...
	bindOncePriority: function bindOncePriority(signal, func, self) {
		if (!this._callStacks[signal]) {
			this._callStacks[signal] = [];
		}
	...
	// unbind the event
	unbind: function unbind(signal, func, self) {
		if (!this._callStacks[signal]) {
			return;
		}
	...
	// destroy a signal
	destroy: function destroy(signal) {
		this._callStacks[signal] = undefined;
	},

	// dispatch the event
	call: function call(signal, data) {
		if (this.debugMode) {
			if (!this.logger) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=whevent.js.map
